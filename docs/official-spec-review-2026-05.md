...
> **SUPERSEDED (2026-05-29)**: this review was generated against a now-redirected documentation
> host and undercounted the official surface (it reports 18 hook events / ~10 unused settings
> keys; the live surface is ~30 events / ~94 keys). See
> `docs/official-spec-rereview-2026-05-29.md` for the corrected current ground truth. Text below
> retained for history.

Re-validation of `claude-config` against the **current Claude Code official documentation**
(`code.claude.com/docs/en/{settings,hooks,skills,sub-agents}`), fetched and
...
`code.claude.com/docs/en/`. Superseded by `docs/official-spec-rereview-2026-05-29.md`.*
