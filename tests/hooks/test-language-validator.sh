...
echo ""
echo "[attribution hard rule — MUST block under every policy (issue #480)]"
# Three-pattern detection: trailer-style at line start, bot emoji adjacent
# to Claude/Anthropic, "Generated|Created|Authored {with|by|using} X" prose.
run_case "english blocks 'Co-authored-by: Claude' trailer"   1 "english"              validate_commit_message "Co-authored-by: Claude"
run_case "korean+en blocks 'Generated by Claude' prose"      1 "korean_plus_english"  validate_commit_message "feat: generated by Claude"
run_case "any blocks 'Created by Anthropic' prose"           1 "any"                  validate_commit_message "feat: created by Anthropic"
# Casual mentions no longer denied — false positives intentionally allowed.
run_case "english allows 'claude' as casual mention"         0 "english"              validate_commit_message "feat: claude assisted refactor"
run_case "any allows 'anthropic' as casual mention"          0 "any"                  validate_commit_message "feat: anthropic reviewed"
