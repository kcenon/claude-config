...
# Trailer-style attribution at line start.
assert_reject "Co-authored-by: Claude" "Co-authored-by trailer"
assert_reject "Generated-by: Anthropic" "Generated-by trailer"
# Bot emoji adjacent to Claude/Anthropic.
assert_reject "feat: 🤖 Claude generated this" "bot emoji + Claude"
# Generated|Created|Authored {with|by|using} {Claude|Anthropic} prose.
assert_reject "feat: generated by Claude" "generated by Claude prose"
assert_reject "feat: created with Anthropic assistance" "created with Anthropic prose"

echo ""
echo "[AI attribution — false-positive prevention (issue #480)]"
# Casual technical mentions are no longer rejected.
assert_accept "feat: add claude integration" "casual 'claude integration'"
