...
#
# Usage:
#   ./gh_issue_comment.ps1 -Number 42 -Body "Comment text"       # Auto-detect repo
#   ./gh_issue_comment.ps1 -Repo owner/repo -Number 42 -Body "Text"
#   ./gh_issue_comment.ps1 -Number 42 -Editor                     # Open editor
#   ./gh_issue_comment.ps1 -Number 42 -Body "Text" -Json          # JSON output
#   ./gh_issue_comment.ps1 -Number 42 -Body "Text" -Quiet         # Minimal output
#   ./gh_issue_comment.ps1 -Help                                   # Show help
#
...
function Print-Header {
    ...
    Write-Host "`u{2551}              GitHub Issue Comment                                   `u{2551}" -ForegroundColor Green
...
function Show-Help {
    ...
    Write-Host '  ./gh_issue_comment.ps1 -Number 42 -Body "Fixed in commit abc123"'
    Write-Host '  ./gh_issue_comment.ps1 -Repo kcenon/thread_system -Number 10 -Body "LGTM"'
    Write-Host '  ./gh_issue_comment.ps1 -Number 42 -Editor'
    Write-Host '  ./gh_issue_comment.ps1 -Number 42 -Body "LGTM" -Json   # {"url":"..."}'
    Write-Host ''
}
...
Print-Info "Issue:      #$Number"

# Build gh command
$ghArgs = @('issue', 'comment', $Number, '--repo', $Repo)
